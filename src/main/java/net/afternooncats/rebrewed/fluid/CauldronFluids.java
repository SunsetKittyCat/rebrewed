...
public class CauldronFluids {
    ...
    public static VanillaCauldronFluid EMPTY_FLUID = Registry.register(CAULDRON_FLUID, Identifier.of("minecraft", "empty"), new VanillaCauldronFluid(ColorHelper.Argb.getArgb(0, 0, 0), 0, false, Blocks.CAULDRON));
